module.exports = {
  // Добавляем описание на русском языке ко всем типам
  types: [
    { value: 'build', name: 'build: Сборка проекта или изменение внешних зависимостей' },
    { value: 'ci', name: 'ci: Настройка CI или работа со скриптами' },
    { value: 'docs', name: 'ci: Обновление документации' },
  ...
  scopes: [{ name: 'components' }, { name: 'api' }, { name: 'uiKit' }, { name: 'config' }],
  // Переопределение дефолтных вопросов
  messages: {
    ...
    footer: 'Место для метаданных (тикетов, ссылок и остального). Например: LKZTEAM-2415:\n',
